...
nnoremap <silent> ]d :call VSCodeNotify('editor.action.marker.next')<CR>
xnoremap <silent> ]d :call VSCodeNotify('editor.action.marker.next')<CR>
nnoremap <silent> [d :call VSCodeNotify('editor.action.marker.prev')<CR>
xnoremap <silent> [d :call VSCodeNotify('editor.action.marker.prev')<CR>
